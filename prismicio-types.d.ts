...
export interface ExperienceSliceDefaultPrimary {
  ...
  /**
   * experiences field in *Experience → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.primary.experiences[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
...
export interface TechListSliceDefaultPrimary {
  ...
  /**
   * Tech List field in *TechList → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.primary.tech_list[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  tech_list: prismic.GroupField<Simplify<TechListDocumentDataTechListItem>>;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      TechListSlice,
      TechListDocumentDataTechListItem,
